...
# Middleware 
socket: mkdir middleware/socket.o backend/birdcage_webserver.o backend/pigeondrop_webserver.o backend/pigeonfly_webserver.o backend/pigeonshred_webserver.o
	gcc $(FLAGS) -DWEBSERVER -o middleware/socket middleware/socket.o backend/obj/birdcage_webserver.o backend/obj/pigeondrop_webserver.o backend/obj/pigeonfly_webserver.o backend/obj/pigeonshred_webserver.o
...
backend/pigeonshred_webserver.o: mkdir backend/src/pigeonshred.c
	gcc $(FLAGS) -DWEBSERVER -c backend/src/pigeonshred.c -o backend/obj/pigeonshred_webserver.o

backend/birdcage_webserver.o: mkdir backend/src/birdcage.c $(HEADERS)
	gcc $(FLAGS) -DWEBSERVER -c backend/src/birdcage.c -o backend/obj/birdcage_webserver.o
